...
public class BoardController {
    ...
    public String getBoard(BoardVO vo, HttpServletRequest request, Model model, @RequestParam("boardId") int boardId) throws Exception {
    ...
    //글 등록
    //   @RequestMapping(value="/"RboardCreate.do"")
    //   public String insertBoard(RBoardVO vo) throws IOException {
    //      // 파일 업로드 처리
