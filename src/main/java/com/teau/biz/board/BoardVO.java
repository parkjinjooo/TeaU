...
public class BoardVO {
    ...
    private int amount = 9; //페이지당 데이터 갯수
    ...
    public String toString() {
        return "BoardVO [boardId=" + boardId + ", boardCate=" + boardCate + ", boardWriter=" + boardWriter
                + ", boardTitle=" + boardTitle + ", boardContent=" + boardContent + ", boardHit=" + boardHit
                + ", boardImgm=" + boardImgm + ", boardImg1=" + boardImg1 + ", boardRegdate=" + boardRegdate + "]";
    }
