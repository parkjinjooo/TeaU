            ...
            var memberId = '<%=memberId%>';
                $.ajax({
                  ...
                  success: function (data) {
                    ...
                    $('#boardImg1').text(data['board'].boardImg1);
                      ...
                      <div class="details_content mb-0">
                        ...
                        <div class="wrap_space">
                          ...
                          <div class="container">
                            ...
                            <div class="row">
                              <div class="col" style="text-align: right;"> 
                                <a id="btnUp" class="btn btn_primary text-uppercase" href="boardUpdateMove.do?boardId=<%=boardId%>&boardImgm=<%=boardImgm%>"
                                  style="margin-top: 2.5%;">게시글 수정</a>&nbsp;&nbsp;&nbsp;&nbsp;
                               
                                <a id="btnDel" class="btn btn_primary text-uppercase" href="boardDelete.do?boardId=<%=boardId%>"
                                  style="margin-top: 2.5%;">게시글 삭제</a>
                                  
                              <p id="alertP">게시글의 수정 및 삭제는 글을 작성한 사람만 가능합니다.</p>
                          ...
                          <c:if test="${member.memberId !=null }">
                            <div>
                              <form method="post" action="replyCreate.do">
                                <div>
                                  <div class="col-md-2">
                                          댓글 작성자 :
                                  </div>
