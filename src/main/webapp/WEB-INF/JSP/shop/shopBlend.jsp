...
<!-- breadcrumb_section - start
			...
			<section class="breadcrumb_section0919 text-uppercase"
				...
				<div class="container">
					<h1 class="page_title wow text-white fadeInUp" data-wow-delay=".1s">#베이스별</h1>
			...
			<section class="gallery_section sec_ptb_120 bg_default_gray">
				<div class="container" style="max-width:1300px; margin-top: 5%;">
					...
					<ul class="filters-button-group style_4 ul_li_center wow fadeInUp" data-wow-delay=".1s" style="margin: 0;">
						...
						<li><button class="button text-uppercase" data-filter=".caffeine">녹차</button></li>
						<li><button class="button text-uppercase" data-filter=".caffeine-free">홍차</button></li>
						<li><button class="button text-uppercase" data-filter=".caffeine-free">허브차</button></li>
						<li><button class="button text-uppercase" data-filter=".caffeine-free">기타</button></li>
					</ul>
		<!-- 관리자 로그인 시에만 보임 -->
		...
		<!--상품추가버튼 여기까지-->
					...
					<div class="wrap" style="padding: 1%; ">
						<div class="related_products">
							<h4 class="area_title text-uppercase mb-0 wow fadeInUp" data-wow-delay=".1s">카페인</h4>
							<div class="row">
						...
						<!-- 2번째 -->
						<div class="related_products">
							<h4 class="area_title text-uppercase mb-0 wow fadeInUp" data-wow-delay=".1s">디카페인</h4>
							<div class="row">
