...
<body>
	...
	<section class="breadcrumb_section0919 text-uppercase"
		...
		<div class="container">
			<h1 class="page_title wow text-white fadeInUp" data-wow-delay=".1s">#사용자</h1>
			...
			<div class="wrap" style="padding: 1%;">
				<div class="related_products">
								...
								<div class=" wow recipe_item_grid grid fadeInUp">
									<div class="element-item all " data-category="all">
										...
										<div class="shop_card wow fadeInUp" data-wow-delay=".4s">
											...
											<form>
												<a class="item_image"
													href="shopDetails.do?teaId=${tea.teaId }"> <img
													class="fill" src="resource/imgUpload/${tea.teaImg }"
													alt="image_not_found">
												</a>
												<div class="item_content">
													<h3 class="item_title text-uppercase">
														<a href="shopDetails.do?teaId=${tea.teaId }"
					...
					<div class="row">
						<!-- 학생 -->
						<c:forEach items="${shopUser}" var="tea">
							<c:set var="user" value="${tea.tagUser }" />
							<c:if test="${fn:contains(user, '학생')}">
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class=" wow recipe_item_grid grid fadeInUp">
										<div class="element-item student" data-category="student">
											<div class="shop_card wow fadeInUp" data-wow-delay=".4s">
					...
					<div class="row">
						<c:forEach items="${shopUser}" var="tea">
							<c:set var="user" value="${tea.tagUser }" />
							<c:if test="${fn:contains(user, '직장인')}">
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class=" wow recipe_item_grid grid fadeInUp">
										<div class="element-item worker " data-category="worker">
											<div class="shop_card wow fadeInUp" data-wow-delay=".4s">
												<a class="wishlist_btn" href="#!"><i
													class="fal fa-heart"></i></a>
												<form>
					...
					<div class="row">
						<c:forEach items="${shopUser}" var="tea">
							<c:set var="user" value="${tea.tagUser }" />
							<c:if test="${fn:contains(user, '임산부')}">
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class=" wow recipe_item_grid grid fadeInUp">
										<div class="element-item pregnant " data-category="pregnant">
											<div class="shop_card wow fadeInUp" data-wow-delay=".4s">
												<a class="wishlist_btn" href="#!"><i
													class="fal fa-heart"></i></a>
												<form>
					...
					<div class="row">
						<c:forEach items="${shopUser}" var="tea">
							<c:set var="user" value="${tea.tagUser }" />
							<c:if test="${fn:contains(user, '어르신')}">
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class=" wow recipe_item_grid grid fadeInUp">
										<div class="element-item elder " data-category="elder">
											<div class="shop_card wow fadeInUp" data-wow-delay=".4s">
												<a class="wishlist_btn" href="#!"><i
													class="fal fa-heart"></i></a>
												<form>
